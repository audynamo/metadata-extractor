        ...
        try {
            ...
            while (!stack.empty()) {
                ...
                for (int tagNumber = 0; tagNumber < dirTagCount; tagNumber++) {
                    ...
                    //
                    if (byteCount == 4 && handler.isTagIfdPointer(tagId)) {
                        final int subDirOffset = currentTiffHeaderOffset + reader.getInt32(tagValueOffset);
                        stackInfo.returnLocation = 1;
                        stackInfo.tagNumber = tagNumber;
                        ...
                        if (!handler.customProcessTag(tagValueOffset, processedIfdOffsets, currentTiffHeaderOffset, reader, tagId, byteCount)) {
                            processTag(handler, tagId, tagValueOffset, componentCount, formatCode, reader);
                        }
                    }
                }
